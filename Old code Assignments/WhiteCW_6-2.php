...
//in_array for 6-3
if (!empty($course) && array_key_exists($course,$classes)){
	echo "Code: ".$course." Description:".$classes[$course];
}else{
...
<form action = 'WhiteCW_6-2.php' method = 'post'> 
<table border = '1'> 
...
echo "</table>"; 
?>
<p>"Course Title" <input type="text" name="course"/></p>
